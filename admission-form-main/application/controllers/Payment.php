    ...
    public function request()
    {
        ...
        $data=array(
           ...
           'form_no'=>$form_no
                ...
                $this->dbconnection->insert('adm_transaction',$data);
        ...
        public function response(){           
            ...
            $trans_cnt_query = $this->dbconnection->select('adm_transaction', 'count(id) as cnt', "id=$trans_id and (response_code=0 or response_code=2) and status='Y'");
            ...
            $this->dbconnection->update("adm_transaction", $data, "id=$trans_id");
    ...
    public function request2()
    {
        ...
        $data=array(
           ...
           'form_no'=>$form_no
                ...
                $this->dbconnection->insert('adm_transaction_final',$data);
                $last_id=$this->db->insert_id();
                ...
                $this->load->view('user/payment/ccavRequestHandler1',$requestData);
    }
        ...
        public function response2(){           
            ...
            $trans_id = $response['merchant_param1'];
            $trans_cnt_query = $this->dbconnection->select('adm_transaction_final', 'count(id) as cnt', "id=$trans_id and (response_code=0 or response_code=2) and status='Y'");
            if ($response['order_status'] === "Success") {
                $responseCode = 0;
                $statusCode = 'S';
            } else {
            ...
            $this->dbconnection->update("adm_transaction_final", $data, "id=$trans_id");
...
public function request3()
    {
        ...
        $data=array(
           ...
           'form_no'=>$form_no
                ...
                $this->dbconnection->insert('error_transaction',$data);
                $last_id=$this->db->insert_id();
                ...
                $this->load->view('user/payment/ccavRequestHandler2',$requestData);
    }
        ...
        public function response3(){           
            ...
            $trans_id = $response['merchant_param1'];
            $trans_cnt_query = $this->dbconnection->select('error_transaction', 'count(id) as cnt', "id=$trans_id and (response_code=0 or response_code=2) and status='Y'");
            if ($response['order_status'] === "Success") {
                $responseCode = 0;
                $statusCode = 'S';
            } else {
            ...
            $this->dbconnection->update("error_transaction", $data, "id=$trans_id");
