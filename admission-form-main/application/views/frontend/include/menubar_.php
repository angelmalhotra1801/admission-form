			...
			<div class="container-fluid">
				<div class="row">
					...
					<div class="tg-navigationarea tg-headerfixed">
						<strong class="tg-logo"><a href="<?php echo base_url();?>"><img src="<?php echo base_url();?>assets/frontend/images/logo.png" alt="LOGO"></a></strong>
						<div class="tg-socialsignin">
							...
							<div class="tg-userbox">
								<a id="tg-btnsignin" class="tg-btn" href="<?php echo base_url();?>login"><span>sign in</span></a>
								<div class="dropdown tg-dropdown">
									<button class="tg-btndropdown" id="tg-dropdowndashboard" type="button" data-toggle="dropdown">
										<img src="<?php echo base_url();?>assets/frontend/images/author/img-01.jpg" alt="image description">
