                        ...
                        <div id="bgmainwrapper">
                            <div id="insidewrapper">
                                <div class="container" style="text-align: left!important;">
                                  ...
                                  <form action='<?php echo base_url();?>' method='POST' enctype='multipart/form-data' id='admission_form' style="border:1px solid #65a605">
                                        <div class="panel panel-primary">
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <section>
													...
													<input type="hidden" value="<?php echo $value->reg_id;?>" name="reg_id">
                                                    <div class="row">
                                                        <div class="col-md-3">
														  ...
														  <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label>Preferred Job Location :</label>
                                                                  <input type="text" class="form-control" name='job_center'  value="<?php echo $value->job_center;?>" placeholder="Job Location">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <label>
                                                            ...
                                                            <div id="post_details_non_teach">
                                                             <select name="non_teaching"  class="form-control"  value="<?php echo $value->non_teaching;?>>
                                                               <option value="">Select</option>
                            ...
                            <section>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name='fname' value="<?php echo $value->fname;?>" placeholder="Candidate NAME">
                                        </div>
                                    </div>
                                      ...
                                      <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name='fathername'  value="<?php echo $value->fathername;?>" placeholder="Father NAME">
                                        </div>
                                    </div>
									     <div class="col-md-4">
                                        <div class="form-group">
                                            <label><span style="color:red">*</span>&nbsp; Mother Name:</label>
                                            <input type="text" class="form-control" name='fathername'  value="<?php echo $value->mothername;?>" placeholder="Mother NAME">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
										...
										<label style="margin-left: 10px;"><input class="form-check-input" type="radio" name='gender' value="<?php echo $value->gender;?>" <?php if($ge=='male'){ echo 'checked'; } ?>>MALE</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        
										<label><input class="form-check-input" type="radio" name='gender' value="<?php echo $value->gender;?>" <?php if($ge=='female'){ echo 'checked'; } ?>>FEMALE</label>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="cat"  value="<?php echo $value->cat;?>>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <br>&nbsp;&nbsp;
                                        <label style="margin-left: 10px;"><input class="form-check-input" type="radio" name='marital'   value="<?php echo $value->marital;?>" <?php if($me=='Married'){ echo 'checked'; } ?>>Married </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <label><input class="form-check-input" type="radio" name='marital'  value="UnMarried"   value="<?php echo $value->marital;?>" <?php if($me=='UnMarried'){ echo 'checked'; } ?>>Unmarried</label>                                   
                                    </div> 
                                </div>
                            </div>
                        </section>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="permanent_address" name="permanent_address"><?php echo $value->permanent_address;?></textarea>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="present_address" name="present_address"><?php echo $value->present_address;?></textarea>
                                </div>
                ...
                <section>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <label><span style="color:red">*</span>&nbsp;</label>
                                <input type="text" class="form-control" name="grad_percentage"  value="<?php echo $value->grad_percentage;?>" placeholder="PERCENTAGE">
                            </div>                                  
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label><span style="color:red">*</span>&nbsp;</label>
                                <input type="text" class="form-control" name="grad_subject"  value="<?php echo $value->grad_subject;?>" placeholder="SUBJECTS">
                            </div>                                  
                        </div>
                    </div>
                    <hr>
        ...
        <div class="panel-body">
            <section>
                <div class="row">
					...
					<img  id="blah" src="<?php echo base_url().$value->uploads ?>" style="width: 85px;height: 85px;border:1px solid #ccc" />
