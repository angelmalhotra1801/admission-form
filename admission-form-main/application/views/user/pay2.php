...
<div class="main-body" style="margin-top: -34px;">
 ...
 -->
                                    ...
                                    <div class="panel-body">
                                      <form class="form-horizontal" method="POST" name="admissionFrm" role="form" id="admissionFrm" action="<?php echo base_url("Payment/request2"); ?>">
                                        ...
                                        <tbody>
                                          <tr>                                            
                                            ...
                                            <td><?php echo $name;?></td>
                                            <td>&#8377 &nbsp;<?php echo $amount;?></td>
                                            </tr>
                                            <tr>
                                              <td colspan="4">
                                               <center>Final Admission is subject to the verification of Marks in Board results</center>
                                               <center><b>Payment once made cannot be refunded.</b></center>
                                            </td>
                                            </tr>

                                          <tr>  
                                             <input type="hidden" name="form_no" value="<?php echo $application_no;?>">
                                             <input type="hidden" name="fees" value="<?php echo $amount;?>">
                                             <input type="hidden" name="uid" value="<?php echo $this->session->userdata('uid');?>">
                                            <td colspan="4">
                                                <center><a class="btn" data-toggle="modal" data-target="#myModal2" style="padding: 5px 19px;background-color:#353c4e;color:#ffffff;border-radius:5px;" disabled>Pay Now</a></center>
                                            </td>
                                          </tr>
                                        </tbody>
                                      </table>
