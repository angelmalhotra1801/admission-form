    ...
    <script type="text/javascript" src="<?php echo base_url();?>assets/pages/prism/custom-prism.js"></script>
    <script src="<?php echo base_url();?>assets/js/pcoded.min.js"></script>
    <script src="<?php echo base_url();?>assets/js/horizontal-layout.min.js"></script>
