...
<body style="width:90%;">
  ...
  <header class="clearfix">
    <div id="logo">
       ...
       <!-- <img src="assets/davhzb.png" alt="DAV Bariatu" style="width:16%"><br> -->
      <br/>
      <div id="project">
        <div><span></span>DAV PUBLIC SCHOOL BARIATU   </div>
        <div><span></span> Bariatu Rd, opp. Bariatu Housing, Bariatu, Ranchi, Jharkhand 834009</div>

      </div>
    </div>
    <h1>ONLINE ADMISSION FORM XI</h1>
  ...
  <center>
<!-- <h1>Student Image</h1>
      <img src="<?php echo base_url();?>uploads/images/<?php echo $value->student_img;?>" style="height:100px;width:100px;"alt="" > -->
</center>
<h1>Form Details</h1>
  ...
  <table class="table table-bordered">
    ...
    <tr>
      <th>STUDENT CATEGORY IN CLASS 10</th>
  ...
  <?php } ?>
   ...
   <tr>
     <th>GROSS ANNUAL INCOME OF THE FATHER</th>
     <td><?php echo $value->monthly_inc_father;?></td>
   </tr>

   <tr>
     <th>GROSS ANNUAL INCOME OF THE MOTHER</th>
     <td><?php echo $value->monthly_inc_mother;?></td>
   </tr>

   <tr>
     <th colspan="2" class="mi"><b><br><br>PERMANENT ADDRESS</b></th>
   </tr>
...
?>
   ...
   <tr style="margin-top: 15px;">
     <th colspan="2"  class="mi"><br><br><b>PRESENT ADDRESS</b></th>
   </tr>
   <?php
...
<tr>
 <td> WHETHER RECOGNIZED BY STATE/CENTRAL/ICSE BOARD</td>
 <th><?php echo $value->board;?></th>
</tr>
</table>
<table class="table table-bordered">
  <tr>
   <th colspan="2"  class="mi"> MARKS OBTAINED IN PREBOARD OF STD. X.</th>
 </tr>
...
<tr>
 <td>MATHEMATICS</td>
 <th><?php echo $value->mathematics;?></th>
</tr>

<tr>
 <td>SCIENCE</td>
 <th><?php echo $value->science;?></th>
</tr>
<tr>
 <td>SOCIAL SCIENCE</td>
 <th><?php echo $value->social_science;?></th>
</tr>
<tr>
 <td>HINDI</td>
 <th><?php echo $value->hindi;?></th>
</tr>
