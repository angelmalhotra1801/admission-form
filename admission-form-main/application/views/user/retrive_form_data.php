                                        ...
                                        <div class="panel panel-primary">
                                            ...
                                            <div class="panel-body">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="date" class="form-control birth_date" name='dob' placeholder="D/O/B" id="birth_date" value="">
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="col-md-4" style="display: none" id="post">
                                                    <div class="form-group">
                                                        ...
                                                        <label>
                                                            <div id="post_details">
                                                                <select class="form-control" name="teaching_post" onChange="getsat(this.value)">
                                                                    <option value="">--Select--</option>
                                           ...
                                           <div class="col-md-4"  style="display: none" id="sub">
                                            <div class="form-group">
                                                ...
                                                <label>
                                                    <div id="sub_details">
                                                        <select class="form-control" name="pgt_teaching">
                                                            <option value="">--Select--</option>
                                                    ...
                                                    <div id="sub_det">
                                                       <select class="form-control" name="tgt_prt_teaching">
                                                        <option value="">--Select--</option>
                                                        <option value="ENGLISH">ENGLISH</option>
                            ...
                            <section>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name='aadhar' placeholder="ADHAAR NUMBER">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name='mat_year' placeholder="YEARS">
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                                <label><span style="color:red">*</span>&nbsp;</label>
                                <input type="text" class="form-control" name='mat_board' placeholder="BOARD/UNIVERSITY">
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <label><span style="color:red">*</span>&nbsp;</label>
                                <input type="text" class="form-control" name="mat_percentage" placeholder="PERCENTAGE">
                            </div>                                  
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label><span style="color:red">*</span>&nbsp;</label>
                                <input type="text" class="form-control" name="mat_subject" placeholder="SUBJECTS">
                            </div>                                  
                        </div>
                    </div>
                    <hr>
                    <div class="row">
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name='inter_year' placeholder="YEARS">
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                                <label><span style="color:red">*</span>&nbsp;</label>
                                <input type="text" class="form-control" name='inter_board' placeholder="BOARD/UNIVERSITY">
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <label><span style="color:red">*</span>&nbsp;</label>
                                <input type="text" class="form-control" name="inter_percentage" placeholder="PERCENTAGE">
                            </div>                                  
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label><span style="color:red">*</span>&nbsp;</label>
                                <input type="text" class="form-control" name="inter_subject" placeholder="SUBJECTS">
                            </div>                                  
                        </div>
                    </div>
                    <hr>
                    <div class="row">
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name='grad_year' placeholder="YEARS">
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                                <label><span style="color:red">*</span>&nbsp;</label>
                                <input type="text" class="form-control" name='grad_board' placeholder="BOARD/UNIVERSITY">
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <label><span style="color:red">*</span>&nbsp;</label>
                                <input type="texttext" class="form-control" name="grad_percentage" placeholder="PERCENTAGE">
                            </div>                                  
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label><span style="color:red">*</span>&nbsp;</label>
                                <input type="texttext" class="form-control" name="grad_subject" placeholder="SUBJECTS">
                            </div>                                  
                        </div>
                    </div>
                    <hr>
                    <div class="row">
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name='post_grad_year' placeholder="YEARS">
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                                <label><span style="color:red">*</span>&nbsp;</label>
                                <input type="text" class="form-control" name='post_grad_board' placeholder="BOARD/UNIVERSITY">
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <label><span style="color:red">*</span>&nbsp;</label>
                                <input type="text" class="form-control" name="post_grad_percentage" placeholder="PERCENTAGE">
                            </div>                                  
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label><span style="color:red">*</span>&nbsp;</label>
                                <input type="text" class="form-control" name="post_grad_subject" placeholder="SUBJECTS">
                            </div>                                  
                        </div>
                    </div>
                    ...
                    <div class="row" id="b_ed" style="display: none">
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name='bed_year' placeholder="YEARS">
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                                <label><span style="color:red">*</span>&nbsp;</label>
                                <input type="text" class="form-control" name='bed_board' placeholder="BOARD/UNIVERSITY">
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                                <label><span style="color:red">*</span>&nbsp;</label>
                                <input type="text" class="form-control" name="bed_division" placeholder="DIVISION">
                            </div>                                  
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                                <label><span style="color:red">*</span>&nbsp;</label>
                                <input type="text" class="form-control" name="bed_percentage" placeholder="PERCENTAGE">
                            </div>                                  
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label><span style="color:red">*</span>&nbsp;</label>
                                <input type="text" class="form-control" name="bed_subject" placeholder="SUBJECTS">
                            </div>                                  
                        </div>
                    </div>
                    ...
                    <div class="row" id="ctet"  style="display: none">
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name='ctet_year' placeholder="YEARS">
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                                <label><span style="color:red">*</span>&nbsp;</label>
                                <input type="text" class="form-control" name='ctet_board' placeholder="BOARD/UNIVERSITY">
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                                <label><span style="color:red">*</span>&nbsp;</label>
                                <input type="text" class="form-control" name="ctet_division" placeholder="DIVISION">
                            </div>                                  
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                                <label><span style="color:red">*</span>&nbsp;</label>
                                <input type="text" class="form-control" name="ctet_percentage" placeholder="PERCENTAGE">
                            </div>                                  
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label><span style="color:red">*</span>&nbsp;</label>
                                <input type="text" class="form-control" name="ctet_subject" placeholder="SUBJECTS">
                            </div>                                  
                        </div>
                    </div>
                    <hr>
                    <div class="row">
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name='other_year' placeholder="YEARS">
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                                <label><span style="color:red">*</span>&nbsp;</label>
                                <input type="text" class="form-control" name='other_board' placeholder="BOARD/UNIVERSITY">
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <label><span style="color:red">*</span>&nbsp;</label>
                                <input type="text" class="form-control" name="other_percentage" placeholder="PERCENTAGE">
                            </div>                                  
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label><span style="color:red">*</span>&nbsp;</label>
                                <input type="text" class="form-control" name="other_subject" placeholder="SUBJECTS">
                            </div>                                  
                        </div>
                    </div>
                    <hr>
                    ...
                    <section>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="place_work" placeholder="PLACE WHERE NOW WORKING">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <input type="text" name="exp_name" class="form-control" placeholder="YEARS">
                                    </div>
                                    <div class="col">
                                      <input type="text" name="exp_months" class="form-control" placeholder="MONTHS">
                                  </div>
                              </div>
                          </div>
                      </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="file" required name='img'  id="choose_photo_btn" class="custom-file-input">
